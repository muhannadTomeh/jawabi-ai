  ...
  return (
    <div dir="rtl" className="min-h-screen bg-background text-foreground">
      <div className="mx-auto max-w-3xl px-6 py-12 space-y-6">
        ...
        <section className="space-y-3">
          <h2 className="text-xl font-semibold">وصول فريق الدعم للحسابات</h2>
          <p>قد يقوم فريق الدعم والصيانة في جوابي بالوصول إلى حساب المستخدم داخل المنصة عند الضرورة، لأغراض الدعم الفني، حل المشكلات، أو الصيانة. هذا الوصول:</p>
          <ul className="list-disc ps-6 space-y-1">
            <li>لا يتضمن معرفة كلمة مرور المستخدم — كلمات المرور مشفّرة بشكل غير قابل للاسترجاع ولا يمكن لأي أحد قراءتها.</li>
            <li>يتم عبر رابط دخول مؤقت لمرة واحدة، ويُسجَّل بالكامل في سجل تدقيق داخلي (من دخل، لأي حساب، ومتى، ولماذا).</li>
            <li>لا يُستخدم لأي غرض تسويقي، ولا تتم مشاركة بيانات المستخدم أو محادثات عملائه مع أي طرف ثالث.</li>
          </ul>
          <p>يمكن للمستخدم طلب نسخة من سجلات الوصول الخاصة بحسابه عبر بريد الدعم.</p>
        </section>
